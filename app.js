...
//  정적 파일의 제공
//  express의 static을 app의 미들웨어로 등록
...
app.set("vies", __dirname + "/views");  //  템플릿의 위치 설정
...
function startExpress() {
    ...
    http.createServer(app).listen(app.get("port"), () =>{
        console.log("Web Server is runnig on port ",
            app.get("port"));
    })
}
